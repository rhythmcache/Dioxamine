...
6. **[UI Controls, Dialogs, Buttons and Fullscreen](api/ui.md)**: Show native Material toasts, blocking dialogs, toggle edge-to-edge full-screen mode, intercept Back and Volume buttons, inspect host app version, and open external links in the host device browser.
